...
<div id="page-loader" class="fixed top-0 left-0 right-0 z-50 h-1 hidden">
    <div id="progress-bar" class="h-full bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 transition-all duration-300 ease-out w-0"></div>
</div>
